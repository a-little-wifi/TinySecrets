...
| EPC300         | Server               | Tiny?       | Tiny5 x4-only tall         | IWLUIA     |        |       |            | 8th gen U              | SoC     | 2x DDR4 ?    | 2 / 2       | 2 / 2       | Same as SE50 pretty much          |
...
| Tiny6-P340-pcie-bifurcation-expansion-card | qq8322302         | M90q gen 1, P340          | Tiny6 x8+4       | PCIe x4 (open ended, CPU, x4), M-key M.2 (CPU, x4), M-key M.2 (PCH, x4) | Fan header, MicroSD slot     | Requires motherboard mod for bifurcation |
